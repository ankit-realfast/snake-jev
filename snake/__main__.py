"""uv run python -m snake <command>
  ...
  video                     best and worst game per player: runs/replays.gif and .mp4
"""
...
def cmd_video(args):
    ...
    mp4 = video.write_mp4(RUNS, RUNS / "replays.mp4")
    print(f"{mp4['out']}  {mp4['size'][0]}x{mp4['size'][1]}, {mp4['seconds']}s")
